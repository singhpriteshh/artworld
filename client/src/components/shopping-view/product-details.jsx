...
function ProductDetailsDialog({ open, setOpen, productDetails }) {
    ...
    return (
        ...
        <Dialog className="overflow-auto" open={open} onOpenChange={handleDialogClose}>
                ...
                <div className="">
                    <div className="max-h-[150px] overflow-auto">
                        <div>
                            ...
                            <p className="text-muted-foreground text-2xl mb-5 mb-4">{productDetails?.description}</p>
                        </div>
                    </div>
